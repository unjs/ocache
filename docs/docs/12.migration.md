...
ocache [v0.3.0](https://github.com/unjs/ocache/releases/tag/v0.3.0) is now available. This guide covers upgrading from v0.2. Most applications can upgrade by choosing a storage instance, clearing persistent entries, and auditing what cached HTTP handlers read and return. The [v0.1 to v0.2 summary](#coming-from-v01) covers applications upgrading across both releases.
